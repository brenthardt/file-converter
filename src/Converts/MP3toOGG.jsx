...
function MP3toOGG() {
  ...
  const convertToOGG = async () => {
    ...
    try {
      setConversionStatus("Converting to OGG...");
      const ffmpeg = ffmpegRef.current;
      ...
      setConvertedFileUrl(
        URL.createObjectURL(new Blob([data.buffer], { type: "audio/ogg" }))
      );
