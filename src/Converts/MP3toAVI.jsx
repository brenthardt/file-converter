...
function MP3toAVI() {
  ...
  const convertToAVI = async () => {
    ...
    try {
      setConversionStatus("Converting to AVI...");
      ...
      setConvertedFileUrl(
        URL.createObjectURL(new Blob([data.buffer], { type: "video/avi" }))
      );
      ...
      <div>
        ...
        {convertedFileUrl && (
          <div>
            ...
            if video does not show properly your browser might not support .avi
            file
            <video
